package com.foundation.common.auth.extension.refresh;

import com.foundation.common.auth.config.OAuth2ServerConfig;
import com.foundation.common.core.base.IBaseEnum;
import com.foundation.common.core.constant.AuthConstant;
import com.foundation.common.core.enums.AuthenticationIdentityEnum;
import com.foundation.common.core.utils.RequestUtils;
...
public class PreAuthenticatedUserDetailsService<T extends Authentication> implements AuthenticationUserDetailsService<T>, InitializingBean {
    ...
    public UserDetails loadUserDetails(T authentication) throws UsernameNotFoundException {
        ...
        /*if (clientId.equals(AuthConstant.APP_CLIENT_ID)) {
